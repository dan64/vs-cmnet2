...
from .imfilters import image_luma_merge, w_image_luma_merge, image_weighted_merge, get_image_luma
from .imfilters import chroma_stabilizer, image_tweak, chroma_stabilizer_adaptive
from .vsfilters import vs_tweak, vs_sc_recover_clip_color, vs_sc_recover_gradient_color
from .vsfilters import vs_sc_recover_clip_luma, vs_simple_merge
from .vsutils import CMNET2_LogMessage, MessageType, frame_to_image, image_to_frame, get_ref_images
...
def vs_sc_combine_models(clip_a: vs.VideoNode = None, clip_b: vs.VideoNode = None, method: int = 0, sat: list = (1, 1),
    ...
    if method == 7:
        ...
        raise vs.Error("CMNET2: only dd_method in (0,6) is supported")
